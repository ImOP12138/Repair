...
class AdminMgrController extends BaseProjectAdminController {
    ...
    async createQrLoginCode() {
        let service = new AdminMgrService();
        return await service.createQrLoginCode();
    }

    async checkQrLoginCode() {
        let rules = {
            code: 'must|string|name=登录码',
        };
        let input = this.validateData(rules);

        let service = new AdminMgrService();
        return await service.checkQrLoginCode(input.code);
    }

    async confirmQrLoginCode() {
        await this.isAdmin();
        ...
        let service = new AdminMgrService();
        return await service.confirmQrLoginCode(input.code, this._admin);
    }
    ...
    async bindAdminWx() {
        ...
        let service = new AdminMgrService();
        return await service.bindAdminWx(this._adminId, this._openId);
    }
    ...
    async unbindAdminWx() {
        ...
        let service = new AdminMgrService();
        return await service.unbindAdminWx(this._adminId);
    }

    async loginByWx() {
        let service = new AdminMgrService();
        return await service.loginByWx(this._openId);
    }
}
