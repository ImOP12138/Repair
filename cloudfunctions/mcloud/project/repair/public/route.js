...
module.exports = {
	...
	'passport/login_by_wx_phone': 'passport_controller@loginByWxPhone',
	'passport/login_by_mobile': 'passport_controller@loginByMobile',
	'passport/login_by_password': 'passport_controller@loginByPassword',
	'passport/login_by_sms': 'passport_controller@loginBySms',
	'passport/send_sms_code': 'passport_controller@sendSmsCode',
	'passport/set_password': 'passport_controller@setPassword',
	'passport/change_password': 'passport_controller@changePassword',
	'passport/reset_password': 'passport_controller@resetPassword',
	'passport/check_mobile': 'passport_controller@checkMobileRegistered',
	...
	// 扫码登录
	'admin/qr_login_create': 'admin/admin_mgr_controller@createQrLoginCode',
	'admin/qr_login_check': 'admin/admin_mgr_controller@checkQrLoginCode',
	'admin/qr_login_confirm': 'admin/admin_mgr_controller@confirmQrLoginCode',

	// 微信号绑定登录 - 管理员
	'admin/bind_wx': 'admin/admin_mgr_controller@bindAdminWx',
	'admin/unbind_wx': 'admin/admin_mgr_controller@unbindAdminWx',
	'admin/login_by_wx': 'admin/admin_mgr_controller@loginByWx',

	// 微信号绑定登录 - 工作人员
	'work/bind_wx': 'work/work_home_controller@bindWorkWx',
	'work/unbind_wx': 'work/work_home_controller@unbindWorkWx',
	'work/login_by_wx': 'work/work_home_controller@loginByWx',

	// 管理员操作工作人员微信号
	'admin/member_unbind_wx': 'admin/admin_member_controller@unbindMemberWx',

	// 微信号绑定 - 用户
	'user/bind_wx': 'passport_controller@bindUserWx',
	'user/unbind_wx': 'passport_controller@unbindUserWx',

	// 自动登录检查
	'passport/auto_login_check': 'passport_controller@autoLoginCheck',
