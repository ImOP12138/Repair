...
Page({
	...
	data: {
		isLoad: false,
		fields: projectSetting.TASK_QUOTE_FIELDS,
	},
	...
	bindSubmitCmpt: async function (e) {
		...
		try {
            ...
            await cloudHelper.callCloudSumbit('work/task_quote', params);
            
            let timeHelper = require('../../../../../../helper/time_helper');
			await cloudHelper.transFormsTempPics(forms, 'task-day/' + timeHelper.time('Y-M-D') + '/', id, 'work/task_update_quote_forms');
